...
//<script language="javascript" src=“WebCalendar.js” type="text/javascript" charset="utf8"></script>
...
Calendar.prototype.draw = function () {
    ...
    obj.onclick = function () {
        ...
        try {
            datechange(calendar.dateControl);
        }
        catch (e) {
...
//取得HTML控件绝对位置     var objx = document.getElementById(obj_s.id + "_x");
//if (objx != null) {
...
Calendar.prototype.getAbsPoint = function (e) {
    ...
    while (e = e.offsetParent) {
        x += e.offsetLeft;
        y += e.offsetTop;
        if (e.tagName == "TABLE" || e.tagName == "table") {
            if (e.parentNode.tagName == "DIV") {
                x0 = e.parentNode.scrollLeft;
                x = x - x0;
                y0 = e.parentNode.scrollTop;
                y = y - y0;
            }
        }
    }
...
document.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:155px;font-size:9px;"></div>');
document.write('</div>'); 