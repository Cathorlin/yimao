...
using System.Text;
public partial class MLeft : BasePage
    {
        ...
        public string get_html_(DataRow dr_menu,int node_)
        {
            ...
            if (node_ == 1)
            {
                ...
                {
                    str_html_.Append("<tr><td align=left class=\"ftd\" onclick=\"showchild('" + menu_id_ + "')\">");
                }
                else
                {
            ...
            else
            {
                if (dt_menu_child.Rows.Count > 0)
                {
                    str_html_.Append("<tr><td align=left class=\"ttd\" onclick=\"showchild('" + menu_id_ + "')\">");
                }
                else
                {
