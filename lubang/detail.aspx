<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detail.aspx.cs" Inherits="lubang_detail" %>
...
<head>
    ...
    <link href="ueditor1_3_6-gbk-net/themes/default/css/umeditor.css" type="text/css"  rel="stylesheet">
    <script type="text/javascript" src="js/jquery-1.4.1.js"></script>
    <script type="text/javascript" src="js/jquery.form.js"></script>
    <script type="text/javascript" charset="gbk" src="ueditor1_3_6-gbk-net/ueditor.config.js"></script>
    <script type="text/javascript" charset="gbk" src="ueditor1_3_6-gbk-net/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="gbk" src="ueditor1_3_6-gbk-net/lang/zh-cn/zh-cn.js"></script>
     ...
     <script type="text/javascript">
        ...
        { }
         ...
         function showmsg(id, pic) {
             $("#img_" + id).attr("src", "..\\images\\M00201\\" + pic);
         }
         function Send_All() {
//             var str_ = encodeURIComponent(UE.getEditor('myEditor').getContent());
//             $("#show_html").val(str_);
//             $("#txtform").submit();
        ...
        <div class="w_main">
            <ul>
                        ...
                        <div class="img_size">
                            <ul>
                                 <%
                                     ...
                                     if (j==0){
                                        id_ = "SHOPICON";
                                        picname = dt_m00203.Rows[0][id_].ToString();
                ...
                <li>
                    <%if (i>0&&i<=2)
                      { %>
                    <span style="color: Red;">网点形象图</span>
                    <%} %>
                    <%if (i>2&&i<=4)
                      { %>
                    <span style="color: Red;">网点介绍图</span>
                    <%} %>
                    <br/>
                        <form  id="f_<%=id_ %>" name="f_<%=id_ %>" method="post"   enctype="multipart/form-data"  class="formUpload">                                     
                         ...
                         <input type="file" style="width:102px;" name="file"  title="仅限图片和常用文档格式，文件最大不可以超过2M,图片建议500kb以下为宜"/>
                      ...
                      <tr>
                       <td>
                        <input id="Submit1" type="submit" value="删除图片" class="input_on" />
                       </td>
                      </tr>
                    </table>
                          </form>                                     
                    ...
                    <%if (j==0)
                      { %>
                    <span style="color: Red;">店铺LOGO</span>
                    <%} %>
                    <%if (j==5)
                      { %>
                    <span style="color: Red;">二维码</span>
                    <%} %>
                    <br/>
                        <form  id="Form1" name="f_<%=id_ %>" method="post"   enctype="multipart/form-data"  class="formUpload">                                     
                         <table>
                         <tr>
                         <td>
                            <img id="img_<%=id_ %>" alt="" src="<%=picname %>" width="102px" height="76px" /> 
               ...
               <%-- <li>
                    <div class="w_right2">          
                         <script id="myEditor" type="text/plain" style="width:622px;height:300px;"></script>
                    </div>
                </li>--%>
            </ul>
            <div class="w_button">
