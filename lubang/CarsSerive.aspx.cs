...
public partial class CarsSerive : System.Web.UI.Page
{
    ...
    public DataTable dt_m00202_m036 = new DataTable();
    ...
    private void BindData()
    {
        ...
        sqlstr = "select * from M00203_LB01 t where pkg_m00203.m00203_serch('" + conditon + "',t.m00203_key) = 1";
        //if (m036_key != "")
        //{
        ...
        ////}
        //orderbystr = "order by m00202_key desc))) order by m00202_key desc";
        sql = sqlstr;
        ...
        db.ExcuteDataTable(dt_m00202_m036, sql, CommandType.Text);
        this.ListView1.DataSource = dt_m00202_m036;
