...
<body>
        ...
        <div class="w_main">
            <ul>
                        ...
                        <div class="img_size">
                            <ul>
                                 <% for (int i = 1; i <= 1; i++)
                                {
                                    ...
                                    string picname = dt_m00203.Rows[0][id_].ToString();
                ...
                <li>
                    <%if (i>0&&i<=10)
                      { %>
                    <span style="color: Red;">手机小图200*200</span>
                    <%} %>
                    <%if (i>10&&i<=20)
                      { %>
                    <span style="color: Red;">手机大PC小310*232</span>
                    <%} %>
                    <%if (i == 21)
                      { %>
                    <span style="color: Red;">PC大图500*330</span>
                    <%} %>
                    <br/>
            ...
            <div class="w_button">
               ...
               <%--  <form id="txtform" name="txtform" method="post"  enctype="multipart/form-data" class="formUpload">
                    <input  type="hidden"  name="key" value="SHOW_HTML"/>
                    <input type="hidden"   name ="mainkey" value="<%=mainkey %>" />
    ...
    <script type="text/javascript">
        ...
        ue.addListener("ready", function () {
            // editor准备好之后才可以使用
            var str_ = '<%=dt_m00203.Rows[0]["SHOW_HTML"].ToString() %>';
            ue.setContent(str_);

        });
        // UE.getEditor('myEditor').setContent('欢迎使用ueditor',true)
        //按钮的操作
    </script>
</body>
</html>
