...
d[g]=b[c]}"object"==typeof module&&"object"==typeof module.exports?module.exports=k:a.define&&a.define.amd?a.define(function(){return k}):(h=a[j],a[j]=k,a[j].noConflict=function(){a[j]=h})}(b.modules)}(this);